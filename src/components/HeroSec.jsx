...
const HeroSec = () => {
  ...
  const socialLinks = [
    { icon: <FiLinkedin className="text-[#2d83f3] text-3xl sm:text-4xl" />, url: "https://www.linkedin.com/in/qurat-ul-aien" },
    { icon: <FiFacebook className="text-[#3f92ff] text-3xl sm:text-4xl" />, url: "https://www.facebook.com/QuratulAien/" },
